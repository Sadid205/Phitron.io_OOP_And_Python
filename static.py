...
class Shopping:
    ...
    @staticmethod
    def multiply(a,b):
        # print(self.name)  # You can't access instance attribute from static method
        result = a*b
        print(result)

    @classmethod
    def hudai_dekhi(self,item):
        # print(self.name) # You can access instance attribute from a classmethod
        print('hudai dekhi kintu just ac er hawa khaite aschi',item)
